...
try:
	...
	print('Script for reformatting and reorganising PAFTOL sequences downloaded from Kew Tree Viewer.')
	...
	print('Output are fasta sequences for each gene as would be produced by HybPiper.')
	print('Use:')
